...
export async function generateInvoicePDF(invoice, client) {
  ...
  autoTable(doc, {
    ...
    styles: {
      fontSize: 10,
      font: "Arial", // Use Arial font here
      textColor: [0, 0, 0],
      halign: "center",
      lineColor: [0, 0, 0],
      lineWidth: 0.3
  ...
  autoTable(doc, {
   ...
   // [2] Add spacing before the note
 // Position near bottom of page (for A4, height ≈ 297mm)
const pageHeight = doc.internal.pageSize.height;

// Add NOTE section with padding above
doc.setFont("helvetica", "bold");
doc.setFontSize(11);
doc.text("NOTE:", 14, pageHeight - 10); // Adjust this to control spacing

doc.setFont("helvetica", "normal");
doc.text(
  "No files will be delivered until the final payment is made.",
  30,
  pageHeight - 10
);
